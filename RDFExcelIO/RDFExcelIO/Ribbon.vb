...
Public Class Ribbon
    ...
    Public Sub RDFDataSource_Click(ByVal control As Office.IRibbonControl)
        If RDFExcelIO.GetRDFDataSource() Then
            RDFExcelIO.GetMainDataDimension()
        End If
    End Sub

    Public Sub ChangeViewedDimension_Click(ByVal control As Office.IRibbonControl)
        RDFExcelIO.GetMainDataDimension()
    End Sub

    Public Sub RDFOutput_Click(ByVal control As Office.IRibbonControl)
        RDFExcelIO.ConvertToRDF()
    End Sub
