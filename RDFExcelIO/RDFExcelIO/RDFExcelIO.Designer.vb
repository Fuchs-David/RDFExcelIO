...
Partial Public NotInheritable Class RDFExcelIO
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _RDFExcelIO As RDFExcelIO
    ...
    Friend Shared Property RDFExcelIO() As RDFExcelIO
        Get
            Return _RDFExcelIO
        End Get
        Set
            If (_RDFExcelIO Is Nothing) Then
                _RDFExcelIO = value
            Else
